...
test('burndown total grows when scope is added to an already-started sprint (issue #46)', async ({ page }) => {
  ...
  await cardA.locator('.card-menu-date-input[type="number"]').fill('5');
  await cardA.locator('.card-menu-date-input[type="number"]').blur();
  await page.keyboard.press('Escape');
  ...
  await cardB.hover();
  await cardB.locator('.card-menu-btn').click();
  await cardB.locator('.card-menu-date-input[type="number"]').fill('8');
  await cardB.locator('.card-menu-date-input[type="number"]').blur();
  await page.keyboard.press('Escape');
